...
class GmsMatcher:
    ...
    def detect_fearure(self, img1):
        keypoints_image1, descriptors_image1 = self.descriptor.detectAndCompute(img1, np.array([]))

        return keypoints_image1, descriptors_image1

    def compute_matches(self, keypoints_image1, descriptors_image1, keypoints_image2, descriptors_image2):
        ...
        self.normalize_points(keypoints_image1, size1, self.normalized_points1)
        self.normalize_points(keypoints_image2, size2, self.normalized_points2)
